...
import DeviceData from '@/components/Dashboard/ChannelStatisticsPage/StatictickVideo/components/DopTable/Data/DeviceData.jsx'
                                  ...
                                  >
                                    <div className="tableWrapper">
                                      {statistic.age_group_percentages
                                        .length === 0 &&
                                      statistic.gender_percentages.length ===
                                        0 &&
                                      statistic.geo_percentages.length === 0 ? (
                                        ...
                                        >
                                          Ведется аналитика данных
                                        </div>
                                      ) : (
                                        <div
                                          className=" p-[5px] rounded-[22px]"
                                          style={{
