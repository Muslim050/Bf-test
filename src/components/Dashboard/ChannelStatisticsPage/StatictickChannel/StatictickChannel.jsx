                  ...
                  <div className="flex-wrap xl:flex-nowrap flex items-center justify-between gap-7 w-full ">
                    <div className="">
                      <div className="flex xl:flex-nowrap flex-wrap gap-3 ">
                        {/*////*/}
                        <div
                          className="text-base h-[70px] gap-5	text-white flex rounded-[22px]	border border-white items-center px-4	">
                          <div className="xl:text-[28px] text-[18px]">
                            <FormatterView data={dataChannel?.number_of_views}/>

                            <div className="lg:text-[12px] text-[10px]">Кол-во просмотров</div>
                          </div>
                        </div>
                        {/*////*/}
                        <div
                          className="text-base h-[70px] gap-5	text-white flex rounded-[22px]	bg-[#b5e4ca80] items-center px-4	">
                          <div className="xl:text-[28px] text-[18px]">
                            <FormatterView data={dataChannel?.number_of_likes}/>
                            <div className="lg:text-[12px] text-[10px]">Кол-во лайков</div>
                          </div>
                        </div>
                        {/*////*/}
                        <div
                          ...
                          <div className="xl:text-[28px] text-[18px]">
                            ...
                            />
                            <div className="lg:text-[12px] text-[10px]">Кол-во дизлайков</div>
                          </div>
                        </div>
                        {/*////*/}
                        ...
                        <div
                          className="text-base h-[70px] gap-5	text-white flex rounded-[22px]	bg-[#2a85ff75] items-center px-4	">
                          <div className="xl:text-[28px] text-[18px]">
                            <FormatterView
