    ...
    <>
      {loading ? (
        ...
        <div>
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="font-medium text-white sm:text-base text-xs">
                  Отчет
                </div>
          ...
          <div
            className={`relative border_container rounded-[22px] mt-3 p-[3px] glass-background flex flex-col h-full max-h-screen`}
          >
            <div className=" overflow-y-auto sm:max-h-[calc(100vh-330px)] max-h-[calc(100vh-250px)] flex-1">
              {isLoadingData ? (
                <div className="flex w-full items-center space-x-4 p-1">
